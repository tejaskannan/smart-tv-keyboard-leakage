...
SAMSUNG_SOUNDS = frozenset([SAMSUNG_DOUBLE_MOVE, SAMSUNG_KEY_SELECT, SAMSUNG_MOVE, SAMSUNG_SELECT])
APPLETV_SOUNDS = frozenset([APPLETV_KEYBOARD_MOVE, APPLETV_KEYBOARD_DOUBLE_MOVE, APPLETV_KEYBOARD_SELECT, APPLETV_SYSTEM_MOVE])
