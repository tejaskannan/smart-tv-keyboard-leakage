...
APPLETV_MOVE_SOUNDS = frozenset([APPLETV_KEYBOARD_MOVE, APPLETV_KEYBOARD_SCROLL_DOUBLE, APPLETV_KEYBOARD_SCROLL_TRIPLE, APPLETV_KEYBOARD_SCROLL_FOUR, APPLETV_KEYBOARD_SCROLL_FIVE])
