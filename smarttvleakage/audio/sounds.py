...
APPLETV_SOUNDS = frozenset([APPLETV_KEYBOARD_MOVE, APPLETV_KEYBOARD_SELECT, APPLETV_SYSTEM_MOVE, APPLETV_KEYBOARD_DELETE, APPLETV_TOOLBAR_MOVE, APPLETV_KEYBOARD_SCROLL_DOUBLE, APPLETV_KEYBOARD_SCROLL_SIX])
