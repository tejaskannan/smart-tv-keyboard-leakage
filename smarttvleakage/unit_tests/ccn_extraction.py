...
class CreditCardMoveTests(unittest.TestCase):
    ...
    def test_subject_a_month_one(self):
        ...
        expected = [10, 3, 7]
        self.assertEqual(expected, observed_month_moves)
    ...
    def test_subject_a_year_one(self):
        ...
        expected = [2, 4, 8]
        self.assertEqual(expected, observed_year_moves)
    ...
    def test_subject_a_cvv_one(self):
        ...
        expected = [5, 6, 1, 11]
        self.assertEqual(expected, observed_cvv_moves)
    ...
    def test_subject_a_zip_one(self):
        ...
        self.assertEqual(expected, observed_zip_moves)
