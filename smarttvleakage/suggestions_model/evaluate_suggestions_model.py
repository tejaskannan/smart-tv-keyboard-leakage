...
from smarttvleakage.suggestions_model.determine_autocomplete import classify_ms, classify_ms_with_msfd
...
def recover_string(true_word : str, ms : List[int],
                    ...
                    dictionary, max_num_results : int, msfd = None,
    ...
    if suggestions == 0:
        ...
        if msfd is None:
            ...
            use_suggestions = (classify_ms_with_msfd(
            suggestions_model, msfd, move_sequence_vals, auto_cutoff=auto_cutoff, non_cutoff=non_cutoff)[0] == 1)
