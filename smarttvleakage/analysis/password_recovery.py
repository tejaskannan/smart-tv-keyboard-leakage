...
if __name__ == '__main__':
    ...
    print('Accuracy on words in prior: {:.4f} ({} / {}), Top1: {:.4f}, Top50: {:.4f}, Avg Edit Dist: {:.4f}'.format(seen_accuracy, seen_found, seen_total, seen_top1_acc, seen_top50_acc, seen_avg_edit_dist))
    print('Accuracy on words not in prior: {:.4f} ({} / {}), Top1: {:.4f}, Top50: {:.4f},  Avg Edit Dist: {:.4f}'.format(unseen_accuracy, unseen_found, unseen_total, unseen_top1_acc, unseen_top50_acc, unseen_avg_edit_dist))
