...
if __name__ == '__main__':
    ...
    parser.add_argument('--keyboard-type', type=str, choices=['samsung', 'apple_tv_password', 'abc'], help='The optional name of the keyboard to use. Overrides the default specified by the TV type.')
